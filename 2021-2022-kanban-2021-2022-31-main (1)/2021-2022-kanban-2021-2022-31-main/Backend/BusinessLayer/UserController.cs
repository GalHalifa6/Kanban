...
namespace IntroSE.Kanban.Backend.BusinessLayer
{
    public class UserController
    {
        ...
        public bool AddBoard(string email, string name)
        { 
            User user = users[email];
            return user.AddBoard(name);         
        }
        ...
        /*
        internal List<string> GetUserBoard(string email)
        {
            User user = users[email];
            return user.GetUserBoard();
        ...
        */
        ...
        internal string TransferOwnership(string currentOwnerEmail, string newOwnerEmail, string boardName)
        {
            if(GetUser(newOwnerEmail) != null)
            {
                ...
                currentOwner.TransferOwnership(boardName);
            }
